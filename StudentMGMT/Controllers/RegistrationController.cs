...
namespace StudentMGMT.Controllers
{
    ...
    {
        private GlindaaEntities db = new GlindaaEntities();

        // GET: Registration
        public ActionResult Index()
        {
            var registrations = db.registrations.Include(r => r.batch).Include(r => r.course1).Include(r => r.registration1).Include(r => r.registration2);
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course,course_id,batch_id,telephone")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,nic,course,course_id,batch_id,telephone")] registration registration)
        {
            if (ModelState.IsValid)
            {
